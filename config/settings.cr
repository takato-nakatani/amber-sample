...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber Todo web application."
  #
  #
  ...
  #
  # settings.secret_key_base= det4DvI6-1NfAb1_CT2gBo2PutSyQbg0c7vMSZHiqH4
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber-todo.log", "w"))
  #
  #
end
